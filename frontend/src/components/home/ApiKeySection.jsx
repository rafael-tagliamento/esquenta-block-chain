          ...
          <div className="relative w-full max-w-4xl p-8 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
            ...
            <div className="flex-1">
              ...
              <p className="mb-6 text-gray-300">
                ...
                perfil financeiro, expondo o comportamento real das suas ações e
                o impacto de cada decisão. Tenha o controle total sobre seus
                investimentos e transforme incertezas em oportunidades.
              </p>
              ...
              <ol className="list-decimal list-inside space-y-2 mb-6">
                <li>
                  Visite o <a href="https://www.stellar.org/" target="_blank" rel="noopener noreferrer" className="underline decoration-purple-900">site da Stellar</a> e crie uma conta.
                </li>
                <li>
